...
ActiveRecord::Schema.define(version: 20151122185221) do
  ...
  add_index "subscriptions", ["post_subscriber_id"], name: "index_subscriptions_on_post_subscriber_id", using: :btree
  add_index "subscriptions", ["subscribed_post_id"], name: "index_subscriptions_on_subscribed_post_id", using: :btree
